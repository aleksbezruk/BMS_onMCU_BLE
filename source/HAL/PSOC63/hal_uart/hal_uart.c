 ...
 * 
 * @note 'config' isn't nahled by the func, because BSP uses configuration
...
HAL_UART_status_t HAL_UART_init(HAL_UART_config_t *config, HAL_UART_rxCallback_t callback)
{
    ...
    bsp_status_init_t bspStatus = BSP_initUart(callback);
    if (bspStatus != bsp_status_init_success) {
