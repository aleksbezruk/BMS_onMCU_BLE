...
#define CYBSP_DEBUG_UART_RX_PORT CYBSP_UART_RX_PORT
#define CYBSP_UART_RX_PORT_NUM 5U
#define CYBSP_DEBUG_UART_RX_PORT_NUM CYBSP_UART_RX_PORT_NUM
#define CYBSP_UART_RX_PIN 0U
#define CYBSP_DEBUG_UART_RX_PIN CYBSP_UART_RX_PIN
#define CYBSP_UART_RX_NUM 0U
#define CYBSP_DEBUG_UART_RX_NUM CYBSP_UART_RX_NUM
#define CYBSP_UART_RX_DRIVEMODE CY_GPIO_DM_PULLUP
#define CYBSP_DEBUG_UART_RX_DRIVEMODE CYBSP_UART_RX_DRIVEMODE
#define CYBSP_UART_RX_INIT_DRIVESTATE 1
#define CYBSP_DEBUG_UART_RX_INIT_DRIVESTATE CYBSP_UART_RX_INIT_DRIVESTATE
#ifndef ioss_0_port_5_pin_0_HSIOM
    #define ioss_0_port_5_pin_0_HSIOM HSIOM_SEL_GPIO
#endif
#define CYBSP_UART_RX_HSIOM ioss_0_port_5_pin_0_HSIOM
#define CYBSP_DEBUG_UART_RX_HSIOM CYBSP_UART_RX_HSIOM
#define CYBSP_UART_RX_IRQ ioss_interrupts_gpio_5_IRQn
#define CYBSP_DEBUG_UART_RX_IRQ CYBSP_UART_RX_IRQ

#if defined (CY_USING_HAL)
#define CYBSP_UART_RX_HAL_PORT_PIN P5_0
#define CYBSP_DEBUG_UART_RX_HAL_PORT_PIN CYBSP_UART_RX_HAL_PORT_PIN
#define CYBSP_UART_RX P5_0
#define CYBSP_DEBUG_UART_RX CYBSP_UART_RX
#define CYBSP_UART_RX_HAL_IRQ CYHAL_GPIO_IRQ_NONE
#define CYBSP_DEBUG_UART_RX_HAL_IRQ CYBSP_UART_RX_HAL_IRQ
#define CYBSP_UART_RX_HAL_DIR CYHAL_GPIO_DIR_BIDIRECTIONAL 
#define CYBSP_DEBUG_UART_RX_HAL_DIR CYBSP_UART_RX_HAL_DIR
#define CYBSP_UART_RX_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_PULLUP
#define CYBSP_DEBUG_UART_RX_HAL_DRIVEMODE CYBSP_UART_RX_HAL_DRIVEMODE
#endif /* defined (CY_USING_HAL) */

#define CYBSP_UART_TX_ENABLED 1U
#define CYBSP_DEBUG_UART_TX_ENABLED CYBSP_UART_TX_ENABLED
#define CYBSP_UART_TX_PORT GPIO_PRT5
#define CYBSP_DEBUG_UART_TX_PORT CYBSP_UART_TX_PORT
#define CYBSP_UART_TX_PORT_NUM 5U
#define CYBSP_DEBUG_UART_TX_PORT_NUM CYBSP_UART_TX_PORT_NUM
#define CYBSP_UART_TX_PIN 1U
#define CYBSP_DEBUG_UART_TX_PIN CYBSP_UART_TX_PIN
#define CYBSP_UART_TX_NUM 1U
#define CYBSP_DEBUG_UART_TX_NUM CYBSP_UART_TX_NUM
#define CYBSP_UART_TX_DRIVEMODE CY_GPIO_DM_PULLUP_IN_OFF
#define CYBSP_DEBUG_UART_TX_DRIVEMODE CYBSP_UART_TX_DRIVEMODE
#define CYBSP_UART_TX_INIT_DRIVESTATE 1
#define CYBSP_DEBUG_UART_TX_INIT_DRIVESTATE CYBSP_UART_TX_INIT_DRIVESTATE
#ifndef ioss_0_port_5_pin_1_HSIOM
    #define ioss_0_port_5_pin_1_HSIOM HSIOM_SEL_GPIO
#endif
#define CYBSP_UART_TX_HSIOM ioss_0_port_5_pin_1_HSIOM
#define CYBSP_DEBUG_UART_TX_HSIOM CYBSP_UART_TX_HSIOM
#define CYBSP_UART_TX_IRQ ioss_interrupts_gpio_5_IRQn
#define CYBSP_DEBUG_UART_TX_IRQ CYBSP_UART_TX_IRQ

#if defined (CY_USING_HAL)
#define CYBSP_UART_TX_HAL_PORT_PIN P5_1
#define CYBSP_DEBUG_UART_TX_HAL_PORT_PIN CYBSP_UART_TX_HAL_PORT_PIN
#define CYBSP_UART_TX P5_1
#define CYBSP_DEBUG_UART_TX CYBSP_UART_TX
#define CYBSP_UART_TX_HAL_IRQ CYHAL_GPIO_IRQ_NONE
#define CYBSP_DEBUG_UART_TX_HAL_IRQ CYBSP_UART_TX_HAL_IRQ
#define CYBSP_UART_TX_HAL_DIR CYHAL_GPIO_DIR_OUTPUT 
#define CYBSP_DEBUG_UART_TX_HAL_DIR CYBSP_UART_TX_HAL_DIR
#define CYBSP_UART_TX_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_PULLUP
#define CYBSP_DEBUG_UART_TX_HAL_DRIVEMODE CYBSP_UART_TX_HAL_DRIVEMODE
...
#define CYBSP_DEBUG_UART_RX_config CYBSP_UART_RX_config

#if defined (CY_USING_HAL)
extern const cyhal_resource_inst_t CYBSP_UART_RX_obj;
#define CYBSP_DEBUG_UART_RX_obj CYBSP_UART_RX_obj
#endif /* defined (CY_USING_HAL) */

extern const cy_stc_gpio_pin_config_t CYBSP_UART_TX_config;

#define CYBSP_DEBUG_UART_TX_config CYBSP_UART_TX_config

#if defined (CY_USING_HAL)
extern const cyhal_resource_inst_t CYBSP_UART_TX_obj;
#define CYBSP_DEBUG_UART_TX_obj CYBSP_UART_TX_obj
#endif /* defined (CY_USING_HAL) */
