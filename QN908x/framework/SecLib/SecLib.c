...
/*! *********************************************************************************
* \brief  This function performs AES-128 software encryption on a 16-byte block.
*
* \param[in]  pInput Pointer to the location of the 16-byte plain text block.
*
* \param[in]  pKey Pointer to the location of the 128-bit key.
...
*
********************************************************************************** */
void AES_128_SW_Encrypt(const uint8_t*    pInput,
                        const uint8_t*    pKey,
                        uint8_t*          pOutput)
{
    SecLib_DisallowToSleep();
    ...
    /* call the SW AES-128 Encrypt function from CryptoLib */
    sw_Aes128(pInput, pKey, 1, pOutput);
